export interface DynamicStripesParams extends Record<string, unknown> {
  ...
  segmentColor: string;
  segmentText: string;
  segmentTextNotation: string;
  segmentColorNotation: string;
  margin: number;
...
export const defaultParams: DynamicStripesParams = {
  ...
  segmentTextNotation: "[SCULPTOR]",
  segmentColorNotation: "[#ffffff]",
  margin: 108,
  edgeDivisions: 8,
  lineAngleDeg: 45,
  lineLengthPx: 2200,
...
export const resolveDynamicStripesParams = (
  ...
  const segmentTextNotation = normalizeNotationString(
    raw.segmentTextNotation,
    defaultParams.segmentTextNotation,
  );
  const segmentColorNotation = normalizeNotationString(
    raw.segmentColorNotation,
    defaultParams.segmentColorNotation,
  );
