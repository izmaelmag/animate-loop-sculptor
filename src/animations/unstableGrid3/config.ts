// Configuration for the unstableGrid3 animation (Point Grid based)
...
export const config: UnstableGridConfig = {
  ...
  fps: 60,
  durationInSeconds: 20, // User changed
  ...
  // --- NEW: Seed for Noise ---
  noiseSeedPhrase: "default-unstable-grid-seed-witch", // Default seed phrase
};
