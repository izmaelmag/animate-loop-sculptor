...
import { AnimationController, createAnimationController } from '@/utils/AnimationController';
...
const AnimationContext = createContext<AnimationContextType>({ controller: null });
...
export const AnimationProvider: React.FC<AnimationProviderProps> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    const animationController = createAnimationController(DEFAULT_DURATION, DEFAULT_FPS);
